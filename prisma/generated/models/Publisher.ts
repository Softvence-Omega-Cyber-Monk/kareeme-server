...
export type PublisherWhereInput = {
  ...
  publisherId?: Prisma.StringFilter<"Publisher"> | string
  name?: Prisma.StringNullableFilter<"Publisher"> | string | null
  contactInfo?: Prisma.StringNullableFilter<"Publisher"> | string | null
...
export type PublisherScalarWhereWithAggregatesInput = {
  ...
  publisherId?: Prisma.StringWithAggregatesFilter<"Publisher"> | string
  name?: Prisma.StringNullableWithAggregatesFilter<"Publisher"> | string | null
  contactInfo?: Prisma.StringNullableWithAggregatesFilter<"Publisher"> | string | null
...
export type PublisherOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"publisherId" | "name" | "contactInfo" | "createdAt" | "updatedAt", ExtArgs["result"]["publisher"]>
...
export interface PublisherDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const publisherWithPublisherIdOnly = await prisma.publisher.findMany({ select: { publisherId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Publishers and only return the `publisherId`
   * const publisherWithPublisherIdOnly = await prisma.publisher.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Publishers and only return the `publisherId`
   * const publisherWithPublisherIdOnly = await prisma.publisher.updateManyAndReturn({
   *   select: { publisherId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PublisherFieldRefs {
  readonly publisherId: Prisma.FieldRef<"Publisher", 'String'>
  readonly name: Prisma.FieldRef<"Publisher", 'String'>
  readonly contactInfo: Prisma.FieldRef<"Publisher", 'String'>
